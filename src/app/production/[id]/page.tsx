...
import { Calendar, FileSpreadsheet, FileText, ArrowLeft, RefreshCw, Save } from 'lucide-react';
...
export default function ProductionPage() {
    ...
    // Local State for the document draft
    ...
    return (
        <div className="min-h-screen bg-[#020617] text-white flex flex-col">
            {/* Header */}
            <header className="h-16 border-b border-[#1f2937] flex items-center px-6 gap-4 bg-[#0f172a]">
